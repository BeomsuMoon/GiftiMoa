...
class Home_gift_add_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val brands = mapOf(
            ...
            "커피" to arrayOf("스타벅스", "투썸플레이스", "메가커피", "이디야커피", "할리스", "빽다방", "컴포즈커피","커피빈", "공차", "드롭탑", "커피빈","잠바쥬스","쥬씨","팔공티","파스쿠찌","탐앤탐스"),
            "치킨" to arrayOf("BBQ", "BHC", "굽네치킨","60계치킨","교촌치킨","처갓집","바른치킨","또래오래","지코바","기영이숯불두마리치킨","페리카나","꾸브라꼬숯불두마리치킨","치킨플러스","피자나라치킨공주","이춘봉치킨","또봉이통닭","컬투치킨"),
            "피자" to arrayOf("피자헛", "도미노피자","미스터피자","청년피자","피자나라치킨공주","반올림피자","피자스쿨","유로코피자","파파존스","피자마루","피자알볼로"),
            "패스트푸드" to arrayOf("맥도날드", "버거킹","KFC","롯데리아","프랭크버거","뉴욕버거","맘스터치","버거리","이삭토스트","테그42","샐러디","에그드랍","와플대학"),
            "편의점･마트" to arrayOf("GS25", "CU","세븐일레븐","미니스톱","이마트","이마트24","롯데마트","홈플러스","하이마트","GS슈퍼마켓(TheFRESH)"),
            "베이커리" to arrayOf("뚜레쥬르", "파리바게트","던킨도너츠","크리스피크림도넛","한스제과","파리크라상","CJ","해피콘","홍루이젠","와플대학"),
            "아이스크림" to arrayOf("베스킨라빈스", "설빙","나뚜루","해피콘"),
            "외식･분식" to arrayOf("아웃백", "VIPS","애슐리","샐러디","요기요","배달의민족","본죽","죽이야기","본죽&비빔밥","본도시락","죠스떡볶이","청년다방","역전우동0410","뉴욕야시장","써브웨이","생활맥주","에그드랍","이삭토스트","돼지게티"),
            "영화･엔터" to arrayOf("CGV","롯데시네마","메가박스","컬쳐랜드","해피머니","구글플레이","씨네큐","인생네컷"),
            "기타" to arrayOf("올리브영","CJ온스타일","따릉이","킥고잉")
        )
