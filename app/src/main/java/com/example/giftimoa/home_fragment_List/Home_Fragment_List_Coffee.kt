...
class Home_Fragment_List_Coffee : Fragment() {
    ...
    private fun prepareGiftListData() {
        var gift = Search_Gift("스타벅스", R.drawable.img_brand_starbucks)
        giftList.add(gift)
        ...
        giftList.add(gift)
        gift = Search_Gift("할리스", R.drawable.img_brand_hollys)
        giftList.add(gift)
        gift = Search_Gift("빽다방", R.drawable.img_brand_droptop) //추가
        giftList.add(gift)
        gift = Search_Gift("컴포즈커피", R.drawable.img_composcoffee) //추가
        giftList.add(gift)
        gift = Search_Gift("커피빈", R.drawable.img_brand_coffeebin)
        giftList.add(gift)
