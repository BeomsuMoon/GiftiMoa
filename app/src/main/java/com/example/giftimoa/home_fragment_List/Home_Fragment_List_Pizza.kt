...
class Home_Fragment_List_Pizza : Fragment() {
    ...
    private fun prepareGiftListData() {
        ...
        giftList.add(gift)
        gift = Search_Gift("미스터피자", R.drawable.img_brand_mr_pizza)
        giftList.add(gift)
        gift = Search_Gift("파파존스", R.drawable.img_papajohns)
        giftList.add(gift)
        gift = Search_Gift("반올림피자", R.drawable.img_banolim)
        giftList.add(gift)
        ...
        giftList.add(gift)
        gift = Search_Gift("유로코피자", R.drawable.img_youroco)
        giftList.add(gift)
        gift = Search_Gift("피자스쿨", R.drawable.img_pizzaschool)
        giftList.add(gift)
        gift = Search_Gift("피자나라치킨공주", R.drawable.img_pizzanarachicken)
        giftList.add(gift)
        gift = Search_Gift("청년피자", R.drawable.img_youngmanpizza)
        giftList.add(gift)
