...
class RecyclerViewCategoryBrandAdapter(
    private var CategorytList: MutableList<Home_gift>,
    private val itemClickListener: (Home_gift) -> Unit
) : RecyclerView.Adapter<RecyclerViewCategoryBrandAdapter.CategoryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
        // 현재 위치의 기프트 객체 가져오기
        val gift = CategorytList[position]
    ...
    fun setMyGiftList(myGifts: List<Home_gift>) {
        this.CategorytList = myGifts.toMutableList()
