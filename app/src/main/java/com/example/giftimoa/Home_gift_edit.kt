...
class Home_gift_edit : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            val brandyAdapter = binding.editSpinnerBrand.adapter as? ArrayAdapter<String>
            if (brandyAdapter != null) {
                val indexc = brandyAdapter.getPosition(selectedBrand)
                binding.editSpinnerBrand.setSelection(indexc)
            } else {
                // 어댑터가 null인 경우, 적절한 처리를 해주어야 합니다.
                // 예: 새로운 어댑터를 생성하고 설정하는 등의 처리를 수행합니다.
            }
